...
func setupIndexes() {
	...
	EnsureIndex(context.Background(), db.Collection("messages"), []string{"key"}, options)
	...
	EnsureIndex(context.Background(), db.Collection("messages"), []string{"created"}, expireOpts)
}
